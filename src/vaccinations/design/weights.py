...
class Weights:
    ...
    def disaggregated(self, trust_code: str):
        ...
        path = os.path.join('warehouse', 'vaccinations', 'weights', 'series', 'ltla', 'baseline', 'disaggregated')
    ...
    def aggregated(self, trust_code: str):
        ...
        path = os.path.join('warehouse', 'vaccinations', 'weights', 'series', 'ltla', 'baseline', 'aggregated')
